...
function Step3() {
    ...
    <main>
        <section className='section_container_login section_signin'>
          ...
          <h1 className='logo_name'>e<span>X</span>tremely <span>f</span>rustrated</h1>
          <div className='signin_content'>
            <p>Step 3 - Add your Past Experience</p>
            <p className='signin_description'>
                If you already registered, then no need to create again simply click on Login
            </p>
          </div>
        <div className='main_login_box'>
           <p className='login_text'>You can ADD more than 1 experiences</p>
           <p className='login_text' style={{fontWeight:"660"}}>3 Steps Process</p>
                ...
                <form className='form_login' onSubmit={handleSubmit}>
                    ...
                    type="text">Company Name</InputField>
                    <InputField name="website" placeholder="Enter Website URL" 
                    type="text" >Website</InputField>
                    <InputField name="role" placeholder="Your Role in job/internship" 
                    type="text" >Role</InputField>
                    <InputField name="start" placeholder="Starting date" 
                    type="number" >Starting of Job/Internship</InputField>
                    <InputField name="end" placeholder="Ending date" 
                    type="number" >Ending of Job/Internship</InputField>
                    <InputField name="cover_letter" placeholder="Cover Letter" 
                    type="text" >Cover Letter Link</InputField>
                    <button type='submut'>Add Me &#8599;</button>
                </form>
