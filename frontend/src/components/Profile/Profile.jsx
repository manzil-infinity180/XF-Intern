...
function Profile() {
    ...
    <main>
        ...
        <div className='main_login_box'>
           <p className='login_text'>Register yourself on XF</p>
           <p className='login_text' style={{fontWeight:"660"}}>3 Steps Process</p>
                ...
                <form className='form_login'>
                    ...
                    type="number">Mobile Number</InputField>
                    ...
                    type="number" >Starting Year</InputField>
                    <InputField name="end" placeholder="Expected End year" 
                    type="number" >Expected End Year ?</InputField>
