...
function Navbar() {
    ...
    return (
       ...
       <ul className='h-full flex items-center'>
         <li className='h-full'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
             width="45" height="70" viewBox="0 0 2000 1520">
       ...
       <ul className='lg:flex lg:flex-row h-full group'>
       ...
       <ul className='ml-auto hidden lg:flex lg:flex-row lg:gap-4 pr-8'>
        ...
        {/* <header className="navbar_header"> */}
             ...
             */}
              ...
              {/* <h2 className='logo_name_nav' style={{
                fontSize:"1.5rem",
                textTransform:"none"
              }}>La<span style={{color:"red"}}>G</span>aaN</h2> */}
            {/* </div> */}
